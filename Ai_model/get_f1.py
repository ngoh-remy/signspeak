...
def main():
    ...
    report = classification_report(y_test, y_pred, target_names=encoder.classes_, zero_division=0, output_dict=True)
    
    print(f"MACRO_F1: {report['macro avg']['f1-score'] * 100:.2f}%")
    print(f"WEIGHTED_F1: {report['weighted avg']['f1-score'] * 100:.2f}%")
